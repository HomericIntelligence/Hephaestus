...
def test_precommit_uses_uv_bandit() -> None:
    """The local Bandit hook uses the project-managed environment."""
...
def test_low_severity_baseline_has_integer_counts() -> None:
    """The committed Bandit baseline retains numeric severity counts."""
