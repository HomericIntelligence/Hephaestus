...
def test_planner_timeout_default(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert agent_config.planner_claude_timeout() == DEFAULT_THROUGHPUT_TIMEOUT_S
...
def test_agent_default_timeout_is_generic(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    result = agent_config.agent_default_timeout()
...
def test_agent_default_timeout_ignores_removed_env(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert agent_config.agent_default_timeout() == TWO_HOURS_S
...
@pytest.mark.parametrize(
    ...
    [
        ("HEPH_AGENT_PLAN_TIMEOUT", agent_config.planner_claude_timeout),
        ("HEPH_AGENT_REVIEW_TIMEOUT", agent_config.plan_reviewer_claude_timeout),
        ("HEPH_AGENT_IMPL_TIMEOUT", agent_config.implementer_claude_timeout),
        ("HEPH_AGENT_REVIEW_TIMEOUT", agent_config.pr_reviewer_claude_timeout),
        ("HEPH_AGENT_LEARN_TIMEOUT", agent_config.learn_claude_timeout),
    ],
)
...
def test_advise_timeout_default(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert agent_config.advise_claude_timeout() == TWO_HOURS_S
...
def test_git_message_timeout_ignores_removed_env(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert agent_config.git_message_agent_timeout() == DEFAULT_THROUGHPUT_TIMEOUT_S
