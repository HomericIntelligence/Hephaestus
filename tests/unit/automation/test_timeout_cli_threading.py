...
def test_timeout_helpers_reject_non_positive_values(
    ...
    """All shared timeout flags reject zero and negative values."""
...
@pytest.mark.parametrize(("add_timeout_argument", "flag"), _TIMEOUT_ARGUMENTS)
def test_timeout_help_documents_zero_semantics(
    add_timeout_argument: Callable[[argparse.ArgumentParser], None],
    flag: str,
) -> None:
    """All shared timeout help explains the positive domain and zero behavior."""
    parser = _fresh_parser()
    add_timeout_argument(parser)
