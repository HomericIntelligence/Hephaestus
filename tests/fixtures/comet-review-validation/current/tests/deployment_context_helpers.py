...
from comet.paths import CometPaths, RuntimeEnvironment, atomic_write_json
...
def make_test_context(
    ...
    *,
    ...
    policy = registered_spec.policy.model_copy(
        update={"models": model_policies, "gateway": gateway}
    )
    spec = registered_spec.model_copy(
        update={
            ...
            "credentials": registered_spec.credentials.model_copy(
                update={
                    "keycache_ref": root / "auth" / "keycache.json",
                ...
                "clusters": {
                    cluster_id: {
                        ...
                        "smg": {
                            ...
                            "provenance": {
                                "image_path": str(
                                    registered_spec.cluster_root / "images" / "smg-test.sqsh"
                                ),
                                "image_sha256": "1" * 64,
                            },
                        },
