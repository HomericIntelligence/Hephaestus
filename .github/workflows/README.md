...
| --- | --- | --- |
| _required.yml | Required branch-protection checks, policy gates, fast pre-commit tests, schema, and security gates. | pull_request, merge_group, push to main |
...
| pr3160-macos-evidence.yml | Publishes the issue 3159 production-host receipt for commit `d9dafc1b`. | pull_request |
