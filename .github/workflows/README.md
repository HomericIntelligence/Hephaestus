...
| --- | --- | --- |
| _required.yml | Required branch-protection checks, policy gates, tests, coverage, schema, and security gates. | pull_request, merge_group, push to main |
...
| test.yml | Runs the cross-Python unit/integration test matrix not duplicated by `_required.yml`. | pull_request, merge_group, push to main |
