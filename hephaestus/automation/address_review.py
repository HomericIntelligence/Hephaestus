...
from hephaestus.cli.utils import add_advise_timeout_arg, add_agent_timeout_arg, emit_json_status
...
def main() -> int:
    ...
    options = AddressReviewOptions(
        ...
        # Only override when the CLI flag is set; otherwise the
        # AddressReviewOptions defaults (7200s — not phase-differentiated) apply.
