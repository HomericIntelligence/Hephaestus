# ADR-0019: AGENTS.md is the canonical agent contract
...
Target-branch ADRs 0014 through 0018 already occupy the preceding identifiers,
so this decision uses the next available identifier, 0019.
