...
malformed, unsafe, or mismatched data produces `lock_metadata_error` and stops
dispatch. A durable event contains the waiting operation and process, the
holder operation and process, the holder acquisition time and source, and the
