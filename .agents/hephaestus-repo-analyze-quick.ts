export default {
  id: 'hephaestus:repo-analyze-quick',
  displayName: 'Hephaestus: Repo Analyze Quick',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'run_terminal_command', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: repo-analyze-quick.\n\n' +
    'Quick repository health check.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/repo-analyze-quick/SKILL.md\n' +
