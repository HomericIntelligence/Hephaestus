export default {
  id: 'hephaestus:test-driven-development',
  displayName: 'Hephaestus: Test-Driven Development',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'write_file', 'str_replace', 'run_terminal_command', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: test-driven-development.\n\n' +
    'Enforces RED-GREEN-REFACTOR cycle.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/test-driven-development/SKILL.md\n' +
