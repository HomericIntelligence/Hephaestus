export default {
  id: 'hephaestus:git-worktrees',
  displayName: 'Hephaestus: Git Worktrees',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'run_terminal_command', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: git-worktrees.\n\n' +
    'Creates isolated git worktrees for feature work.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/git-worktrees/SKILL.md\n' +
