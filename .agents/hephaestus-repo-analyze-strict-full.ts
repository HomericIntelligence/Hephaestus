export default {
  id: 'hephaestus:repo-analyze-strict-full',
  displayName: 'Hephaestus: Repo Analyze Strict Full',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'run_terminal_command', 'spawn_agents', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: repo-analyze-strict-full.\n\n' +
    'Strict audit with full file coverage.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/repo-analyze-strict-full/SKILL.md\n' +
