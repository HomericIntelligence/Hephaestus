export default {
  id: 'hephaestus:learn',
  displayName: 'Hephaestus: Learn',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'write_file', 'str_replace', 'run_terminal_command', 'spawn_agents', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: learn.\n\n' +
    'Captures session learnings as a skill in ProjectMnemosyne.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/learn/SKILL.md\n' +
