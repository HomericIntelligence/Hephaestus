export default {
  id: 'hephaestus:create-reusable-utilities',
  displayName: 'Hephaestus: Create Reusable Utilities',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'write_file', 'str_replace', 'run_terminal_command', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: create-reusable-utilities.\n\n' +
    'Ports and generalizes utility scripts.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/create-reusable-utilities/SKILL.md\n' +
