export default {
  id: 'hephaestus:github-actions-python-cicd',
  displayName: 'Hephaestus: GitHub Actions Python CI/CD',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'write_file', 'str_replace', 'run_terminal_command', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: github-actions-python-cicd.\n\n' +
    'Sets up GitHub Actions CI/CD for Python projects.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/github-actions-python-cicd/SKILL.md\n' +
