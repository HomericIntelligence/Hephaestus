export default {
  id: 'hephaestus:code-review',
  displayName: 'Hephaestus: Code Review',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'run_terminal_command', 'spawn_agents', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: code-review.\n\n' +
    'Dispatches a Sonnet code reviewer and guides reception of feedback.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/code-review/SKILL.md\n' +
