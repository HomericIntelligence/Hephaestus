export default {
  id: 'hephaestus:repo-analyze-strict',
  displayName: 'Hephaestus: Repo Analyze Strict',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'run_terminal_command', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: repo-analyze-strict.\n\n' +
    'Ruthlessly thorough repository audit with strict grading.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/repo-analyze-strict/SKILL.md\n' +
