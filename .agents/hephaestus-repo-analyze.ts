export default {
  id: 'hephaestus:repo-analyze',
  displayName: 'Hephaestus: Repo Analyze',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'run_terminal_command', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: repo-analyze.\n\n' +
    'Comprehensive 15-dimension repository audit with grading.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/repo-analyze/SKILL.md\n' +
