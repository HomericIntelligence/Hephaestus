export default {
  id: 'hephaestus:repo-analyze-quick-full',
  displayName: 'Hephaestus: Repo Analyze Quick Full',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'run_terminal_command', 'spawn_agents', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: repo-analyze-quick-full.\n\n' +
    'Quick health check with full file coverage.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/repo-analyze-quick-full/SKILL.md\n' +
