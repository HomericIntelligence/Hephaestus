export default {
  id: 'hephaestus:review-pr-strict',
  displayName: 'Hephaestus: Review PR Strict',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'run_terminal_command', 'spawn_agents', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: review-pr-strict.\n\n' +
    'Ruthlessly thorough PR alignment audit.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/review-pr-strict/SKILL.md\n' +
