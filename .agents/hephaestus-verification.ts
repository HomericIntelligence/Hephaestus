export default {
  id: 'hephaestus:verification',
  displayName: 'Hephaestus: Verification',
  model: 'anthropic/claude-sonnet-4',
  toolNames: ['read_files', 'run_terminal_command', 'end_turn'],
  instructionsPrompt:
    'You are executing the Hephaestus skill: verification.\n\n' +
    'Requires running verification commands before claiming work is complete.\n\n' +
    '## Instructions\n\n' +
    '1. Read the skill definition file at skills/verification/SKILL.md\n' +
